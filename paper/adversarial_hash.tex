...
This framework is extensible to multiple types of cryptographic systems. In this section we will state the task of finding vulnerabilities in multiple cryptographic systems with our framework. In this paper we we validate our framework on hash functions, which will therefore be omitted from this section. 

\begin{itemize}
\item \textbf{PRNGs} Pseudorandom Number Generators must have the property that their output is indistinguishable from a sequence of random numbers. 

\item \textbf{Public Key Generators} 
...
- How would we define this paradigm in each of these contexts? 
